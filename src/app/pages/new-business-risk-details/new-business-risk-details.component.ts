...
@Component({
  selector: 'app-new-business-risk-details',
  standalone: false,
  templateUrl: './new-business-risk-details.component.html',
...
export class NewBusinessRiskDetailsComponent {
  ...
  onupdateCover(event: any, data: any, type: any) {
    event.stopPropagation(); // ✅ prevent triggering row edit on row click
