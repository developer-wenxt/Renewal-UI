...
@Component({
  selector: 'app-date-wise-count',
  standalone: false,
  templateUrl: './date-wise-count.component.html',
  styleUrl: './date-wise-count.component.scss'
})
export class DateWiseCountComponent {
  tableData: any[] = [];
  ...
  getMohtDate() {
    ...
    let urlLink = `${this.RenewalApiUrl}renewalDashBoard/getDailyByWeeksPolLit`;
